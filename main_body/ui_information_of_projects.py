...
################################################################################
## Form generated from reading UI file 'information_of_projects.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.layoutWidget1.setGeometry(QRect(2, 2, 808, 737))
        ...
        self.label_Big_Title = QLabel(self.layoutWidget1)
        ...
        self.lineEdit_No = QLineEdit(self.layoutWidget1)
        ...
        self.lineEdit_Start = QLineEdit(self.layoutWidget1)
        ...
        self.lineEdit_End = QLineEdit(self.layoutWidget1)
        ...
        self.lineEdit_Completion_Progress = QLineEdit(self.layoutWidget1)
        ...
        self.lineEdit_People = QLineEdit(self.layoutWidget1)
        ...
        self.lineEdit_Money = QLineEdit(self.layoutWidget1)
        ...
        self.textEdit_Label = QTextEdit(self.layoutWidget1)
        ...
        self.lineEdit_level = QLineEdit(self.layoutWidget1)
        ...
        self.textEdit_Notes = QTextEdit(self.layoutWidget1)
        ...
        self.label.setGeometry(QRect(1, 4, 811, 741))
        self.label.setPixmap(QPixmap(u":/b6.png"))
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(QCoreApplication.translate("Dialog", u"\u9879\u76ee\u8be6\u60c5", None))
